    ...
    */
    ...
    'connections' => [
        ...
        'default' => [
            ...
            'settings' => [
                'hosts'            => ['192.168.0.170', 'darvsistemas.local'],
                'base_dn'          => 'DC=darvsistemas,DC=local',
                'username'         => 'administrador@darvsistemas.local',
            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'cocacola-bsb.com.br')),
